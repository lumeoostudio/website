...
export const WORKS_GALLERY_IMAGES: GalleryImage[] = Array.from({ length: 30 }, (_, index) => ({
...
export const SITE_GALLERY_IMAGES: GalleryImage[] = [...HERO_GALLERY_IMAGES, ...WORKS_GALLERY_IMAGES];
