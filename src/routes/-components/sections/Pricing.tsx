...
export const Pricing = () => {
  ...
  const prod = productPlans.map((plan) => (
    <Card key={plan.title} className="flex-1 rounded-none bg-[#F9F9FA] p-8 ring-0">
      ...
      <div className="flex flex-col gap-16">
        ...
        <div className="flex flex-col gap-8">
          <Tabs defaultValue="product" className="">
            ...
            <TabsContent value="product" className="flex gap-6">
              {prod}
            </TabsContent>
            <TabsContent value="landing" className="flex gap-6">
              {prod}
            </TabsContent>
            <TabsContent value="branding" className="flex gap-6">
              {prod}
            </TabsContent>
          </Tabs>
        </div>
